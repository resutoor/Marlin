...
const bool Z_MINENDSTOP_INVERTING = false; // set to true to invert the logic of the min endstop. 
...
#define MANUAL_Z_HOME_POS 627.7  // Distance between nozzle and print surface after homing.
